...
models = {# "Inceptionv3"   : ("Inceptionv3",       "Inceptionv3",      "Inceptionv3",    [512, 768, 1024, 1152, 1280, 1408, 1536, 1664, 1792]), 
		  ...
		  "ResNet152"     : ("ResNet152",         "ResNet152",        "ResNet152",      [256, 512, 768, 1024, 2048, 4096]),
          ...
          "VIT"           : ("VIT",               "VIT",               "VIT",           [256, 512, 768, 1024, 2048, 4096]),
          
		  # "BERT"          : ("BERT_Base",         "BERT",             "BERT_Base",      [128, 256, 384, 512, 640, 768, 1024, 1280, 1536]),
          "BERT"          : ("BERT_Base",         "BERT",             "BERT_Base",      [128, 256, 384, 512, 640, 768, 1024, 2048]),
