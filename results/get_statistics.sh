...
if [ "$#" -ne 4 ]; then
    echo "Usage: $0 <model> <policy> <ssd_bandwidth> <ITER> "
    exit 1
fi
...
SSD_BANDWIDTH=$3
ITER=$4
OUTPUT_FILE="$MODEL"_"$POLICY"_"$SSD_BANDWIDTH"_"iter$ITER".txt
